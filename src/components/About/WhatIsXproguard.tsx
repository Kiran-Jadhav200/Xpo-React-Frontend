    ...
    <div className="relative flex flex-col items-center justify-center w-full font-roboto">
      ...
      <div
        className={`relative w-full py-16 px-8 md:px-16 text-white z-10 ${
          isLoading ? "opacity-0" : "opacity-100 animate__animated animate__fadeIn animate__delay-1s"
        }`}
      >
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-2xl md:text-3xl font-medium mb-6">
            <span className="font-bold">Xproguard</span> offers a comprehensive solution for users looking to secure their devices and data in the most efficient way possible. It’s designed to be user-friendly while offering robust protection.
          </p>

          <p className="text-xl md:text-2xl mb-6 leading-relaxed">
            We prioritize your security by providing innovative solutions that safeguard personal and corporate data against cyber threats, data breaches, and attacks.
          </p>

          <p className="text-lg md:text-xl leading-relaxed mb-8 max-w-3xl mx-auto">
            With Xproguard, users gain peace of mind knowing their devices are secure, whether they&apos;re at home or on the go. Our advanced technology continuously adapts to new threats, keeping you one step ahead of potential cyber risks.
          </p>
