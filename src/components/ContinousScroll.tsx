...
const ContinuousScroll = () => {
    ...
    const content = " Cybersecurity Updates ⚡ Threat Detection ◆ Network Protection ⭑ Cloud Security ⬢ Enterprise Solutions ◇ Security Protocols ⬡ Risk Management ⬣ ";
    ...
    return (
        ...
        >
            ...
            <div className="scroll-content">
                <span className="scroll-text" style={scrollingTextStyle}>{content + " " + content}</span>
                <span className="scroll-text" style={scrollingTextStyle}>{content + " " + content}</span>
            </div>
        </div>
    );
