          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-5">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate("/products")} // UPDATED
                className="w-[112px] h-[40px] px-4 py-2 rounded-xl border border-[#52CDDD] text-white bg-transparent hover:bg-[#00102E] transition-all duration-300"
              >
                Download
              </motion.button>
            </div>
        ...
        >
          <div className="flex flex-col space-y-4">
            ...
            <button
              ...
              className="px-4 py-2 rounded-full border-2 border-[#52CDDD] text-white bg-transparent hover:bg-[#52CDDD] transition-all duration-300"
            >
              Download
            </button>
          </div>
