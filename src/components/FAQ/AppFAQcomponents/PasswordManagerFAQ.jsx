...
export default function PasswordManagerFAQ() {
	...
	const questions = [
		{
			...
			answer:
				"Xproguard Password Manager is the most secure way to protect all your passwords with just a single master password. \n\nXproguard uses the Advanced Encryption Standard (AES-256) encryption to keep your passwords safe and secure, and all information is stored locally, so there is no data on our server. We keep your passwords safe and secure wherever you go. \n\nXproguard Password Manager also allows you to store your credit and debit card details securely. In addition, our strong password generator feature will help you create the strongest passwords for extra security. \n\nFinally, unlock the app with PIN or fingerprint authentication and use the local backup feature to store your data in a secure place.",
		},
		{
			question: "How can I restore my password backup?",
			answer:
				"Using Master Password, you can restore your password backup using the following steps: \n\n1. Click on the Restore option in the app settings page. \n\n2. Select the stored password backup file on your device. \n\n3. Enter the master password, and you are done. \n\n All backup passwords will display on the My Password page in the app.",
		},
		{
			question: "Can I restore my password backup without a master password?",
			answer:
				"No, The password data in this password manager is completely encrypted, so for the recovery of any data, you must have a master password. \n\nA reset of the master password is not possible if the original master password has been lost.",
		},
		{
			question: "Why does this app use only local storage backup?",
			answer:
				"Xproguard uses the Advanced Encryption Standard (AES-256) encryption to keep your passwords safe and secure, and all information is stored locally, so there's no need to worry about cloud storage risks.\n\nXproguard Password Manager is a 100% secure app since it doesn't have access to the internet. This app ensures that your passwords and other sensitive information are most secure, protecting you from potential hacks or data breaches.\n\nWithout your master password, no one can access your password backup files.",
		},
		{
			question: "Can I access my password backup after reinstalling the app?",
			answer:
				"Yes, you can access it with your master password, which you met when you created the backup file.",
		},
		{
			question:
				" How can I restore password backup files from my drive or cloud storage?",
			answer:
				"To restore a password backup file from the cloud in the app, follow the below steps. \n\n1. Download the password backup file on your Android mobile device. \n\n2. Click on the Restore option in the app settings page. \n\n3. Select the stored backup file on your device. \n\n4. Enter the master password, and you are done.",
		},
		{
		...
		},
		{
			...
			answer:
				"For Xproguard Password Manager to function, it does not require access to any permissions on your phone.",
		},
		{
