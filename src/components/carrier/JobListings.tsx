...
const jobs: Job[] = [
  {
    ...
    type: 'Part Time',
    location: 'New York',
    image: 'https://cdn.prod.website-files.com/643e232532628163609bd651/645b4543205bc7bd6b41d27d_Avatar%206.jpg',
    url: '/carrier/software-engineer-android',
  },
  {
    id: 2,
    ...
    type: 'Full Time',
    location: 'Mumbai',
    image: 'https://cdn.prod.website-files.com/643e232532628163609bd651/645b455199ba3444971b5442_Avatar%205.jpg',
    url: '/carrier/software-engineer-ios',
  },
  {
    id: 3,
    ...
    type: 'Part Time',
    location: 'London',
    image: 'https://cdn.prod.website-files.com/643e232532628163609bd651/645b455efd781aeee073050e_Avatar%207.jpg',
    url: '/carrier/software-test-engineer',
  },
];
...
const JobListings: React.FC = () => {
  ...
  const handleMouseMove = (e: React.MouseEvent, jobId: number) => {
    ...
    <div>
      <div id="jobListings" className="container mx-auto p-4">
        ...
        <div className="mb-8 lg:flex lg:justify-between lg:pb-8">
          ...
          <p className="mt-4 lg:mt-14 text-base sm:text-lg text-left lg:text-right text-gray-400">
            Are you ready to take your career to the next level and be part of a cutting-edge technology revolution? Look no further than the Intelligent Analytics Suite team!
          </p>
        </div>
        ...
        {jobs.map((job) => (
          <div key={job.id} className="my-8">
            ...
            <Link href={job.url}>
              <div
                className="flex flex-col lg:flex-row items-center justify-between p-4 cursor-pointer relative group"
