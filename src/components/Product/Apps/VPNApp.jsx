...
import VPN1 from "../../../assets/Products/VPN/VPN_1.svg";
import VPN2 from "../../../assets/Products/VPN/VPN_2.svg";
...
const productData = {
  ...
  name: "XPROGUARD VPN",
  shortDescription:
    "Xproguard VPN secures your data and identity while browsing, even on public Wi-Fi. It hides your IP, encrypts traffic, and protects against hackers and snoopers.",
  detailedDescription:
    "Xproguard VPN protects your identity and data while browsing, even on public Wi-Fi. It hides your IP, encrypts traffic, and ensures a secure, private online experience.",
  title2: "Explore the Essential Features of Xproguard VPN",
  icon: VPN1,
  icon2: VPN2,
  features: [
    {
      title: "Secure & Unlimited",
      description:
        "Encrypted connection with no data limits for private browsing.",
    },
    {
      title: "Global Servers",
      description: "Change your IP with multiple worldwide server locations.",
    },
    {
      title: "Fast & Reliable",
      description: "High-speed servers for smooth, uninterrupted browsing.",
    },
    {
      title: "Ad-Free & Easy",
      description: "No ads, simple interface, and dark mode support.",
    },
  ],
  stats: {
    downloads: "1000+",
  ...
  playStoreLink:
    "https://play.google.com/store/apps/details?id=com.xproguard.vpn&hl=en_IN",
  // appStoreLink: "#",
};
