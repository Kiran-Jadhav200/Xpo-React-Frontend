...
import Password1 from "../../../assets/Products/PASSWORD/Password_1.svg";
import Password2 from "../../../assets/Products/PHOTOVAULT/Photovault_2.svg";
...
const productData = {
  ...
  shortDescription:
    "Xproguard Password Manager securely stores all your passwords and card details with AES-256 encryption. Your data stays local, ensuring complete privacy and protection.",
  detailedDescription:
    "Xproguard Password Manager securely stores and manages your passwords, ensuring easy access while keeping them protected. Safeguard your sensitive information with strong encryption and a user-friendly interface.",
  title2: "Explore the Essential Features of Xproguard Password Manager	",
  icon: Password1,
  icon2: Password2,
  features: [
    {
      ...
      description:
        "AES-256 encryption ensures your passwords and card details are stored safely without internet access or cloud risks.",
    },
    {
      title: "Strong Password Generator",
      description:
        "Create highly secure passwords to enhance protection across all your accounts.",
    },
    {
      title: "Organized & Customizable",
      description:
        "Easily manage, categorize, and customize your saved passwords for quick and efficient access.",
    },
    {
      title: "Ad-Free & User-Friendly",
      description:
        " Enjoy a seamless experience with biometric authentication, dark mode, and an intuitive interface.",
    },
  ],
  stats: {
    downloads: "1000+",
  ...
  playStoreLink:
    "https://play.google.com/store/apps/details?id=com.xproguard.passwd&hl=en_IN",
  appStoreLink:
