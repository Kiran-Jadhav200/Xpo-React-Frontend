...
import AntiTheft1 from "../../../assets/Products/ANTI-THEFT/Antitheft_1.svg";
import AntiTheft2 from "../../../assets/Products/ANTI-THEFT/AntiTheft_2.svg";
...
const productData = {
  id: "AntiTheft",
  name: "XPROGUARD ANTI-THEFT",
  shortDescription:
    "Xproguard Anti-Theft secures your device against theft and unauthorized access with advanced protection features. Keep your phone safe from intruders with this comprehensive security app.",
  detailedDescription:
    "Xproguard Anti-Theft protects your device from theft and unauthorized access with advanced security features. Safeguard your phone and personal data with real-time protection against intruders.",
  title2: "Explore the Essential Features of Xproguard Anti-Theft",
  icon: AntiTheft1,
  icon2: AntiTheft2,
  features: [
    {
  ...
  playStoreLink:
    "https://play.google.com/store/apps/details?id=com.xproguard.antitheft&hl=en_IN",
  // appStoreLink: "#",
};
