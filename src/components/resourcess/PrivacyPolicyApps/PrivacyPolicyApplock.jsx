...
export default function PrivacyPolicyApplock() {
	useEffect(() => {
		window.scrollTo(0, 0)
	}, [])
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="relative mb-12 h-[20vh] flex items-center justify-center overflow-hidden rounded-xl">
					...
					<h1 className="relative text-5xl font-bold z-10 text-center">
						Xproguard Applock PRIVACY POLICY
					</h1>
				</div>
				...
				<section className="mb-10">
					...
					<p className="text-neutral-300 mb-4">
						For Xproguard Applock to function it requires access to certain
					...
					<ul className="list-disc pl-5 space-y-2 text-neutral-300">
						...
						<li>
							Overlay (needed): It is used to show a lock screen over a locked
							app.
						</li>
						<li>
							Disable Battery Optimization (needed): To prevent the app from
							being stopped by Android in the background, we need to disable
							battery optimization.
						</li>
						<li>
							Device administrator (optional): It is used when you activate the
							option Prevent AppLock Uninstalled.
						</li>
						<li>
							Camera (optional): It is used to capture a picture of the intruder
				...
				<section className="mb-10">
					...
					<p className="text-neutral-300">
						We made the Xproguard Applock App with your privacy in mind, so we
