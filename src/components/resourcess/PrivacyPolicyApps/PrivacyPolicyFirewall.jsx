...
export default function PrivacyPolicyFirewall() {
	useEffect(() => {
		window.scrollTo(0, 0)
	}, [])
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="relative mb-12 h-[20vh] flex items-center justify-center overflow-hidden rounded-xl">
					...
					<h1 className="relative text-5xl font-bold z-10 text-center">
						Xproguard Firewall PRIVACY POLICY
					</h1>
				</div>
				...
				<section className="mb-10">
					...
					<p className="text-neutral-300 mb-4">
						For Xproguard Firewall to function it requires access to certain
						permissions of your phone. Here is an explanation of how we use
						each:
					</p>
					<ul className="list-disc pl-5 space-y-2 text-neutral-300">
						<li>
							VPN Service Permission: to block apps from accessing the internet
							without root requirements.
						</li>
						<li>
							QUERY_ALL_PACKAGES Permission: to show the list of all installed
							apps where the user can select a particular installed app to stop
							internet access.
						</li>
					</ul>
				</section>
				...
				<section className="mb-10">
					...
					<p className="text-neutral-300">
						We made Xproguard Firewall App with your privacy in mind, so we are
