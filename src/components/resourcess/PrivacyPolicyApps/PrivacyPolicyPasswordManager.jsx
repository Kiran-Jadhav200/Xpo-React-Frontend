...
export default function PrivacyPolicyPasswordManager() {
	useEffect(() => {
		window.scrollTo(0, 0)
	}, [])
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="relative mb-12 h-[20vh] flex items-center justify-center overflow-hidden rounded-xl">
					...
					<h1 className="relative text-5xl font-bold z-10 text-center">
						Xproguard Password Manager PRIVACY POLICY
					</h1>
				</div>
				...
				<section className="mb-10">
					...
					<p className="text-neutral-300 mb-4">
						For Xproguard Password Manager to function it does not require
						access to any permission of your phone.
					</p>
				</section>
				...
				<section className="mb-10">
					...
					<p className="text-neutral-300">
						We made the Xproguard Password Manager App with your privacy in
						mind, so we are not collecting any personal information from users.
					</p>
				</section>
